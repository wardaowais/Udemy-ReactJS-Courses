//For every fecth case to be functional, i need to construct a Fetch case first and make it equal to the same stringname 
//So it can work in the action folder and reducer folder, where I tend to make my fetch cases and create functions connected to the specific Fetch
