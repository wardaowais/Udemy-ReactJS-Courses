import { FETCH_OFFERS_SUCCESS, CHANGE_OFFER_STATUS,  
  REQUEST_RESOURCE, FETCH_RESOURCE_SUCCESS } from '../types';
...
//now i can with take accept and delinceoffer and dispatch it in Pages, offers - ReceivedOffer.js in import
...
export const declineOffer = offerId => dispatch =>
  api.changeOfferStatus(offerId, 'declined')
    .then(_ => dispatch({type: CHANGE_OFFER_STATUS, status: 'decline', offerId, offersType: 'received'}))
